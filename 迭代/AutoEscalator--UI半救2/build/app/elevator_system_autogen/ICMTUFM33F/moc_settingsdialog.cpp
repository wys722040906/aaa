...
QT_MOC_LITERAL(8, 99, 11), // "onOKClicked"
QT_MOC_LITERAL(9, 111, 15), // "onCancelClicked"
QT_MOC_LITERAL(10, 127, 20), // "onDayDurationChanged"
QT_MOC_LITERAL(11, 148, 5), // "value"
QT_MOC_LITERAL(12, 154, 13) // "validateInput"

    },
    "SettingsDialog\0settingsChanged\0\0"
    "maxPassengers\0floorTravelTime\0idleTime\0"
    "dayDuration\0requestInterval\0onOKClicked\0"
    "onCancelClicked\0onDayDurationChanged\0"
    "value\0validateInput"
};
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->settingsChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4])),(*reinterpret_cast< int(*)>(_a[5]))); break;
        ...
        {
            using _t = void (SettingsDialog::*)(int , int , int , int , int );
...
// SIGNAL 0
void SettingsDialog::settingsChanged(int _t1, int _t2, int _t3, int _t4, int _t5)
{
