...
#include <memory>
#include "../../../../app/include/ui/ElevatorWidget.h"
...
QT_MOC_LITERAL(3, 30, 17), // "handleStateChange"
QT_MOC_LITERAL(4, 48, 15), // "Elevator::State"
QT_MOC_LITERAL(5, 64, 5), // "state"
QT_MOC_LITERAL(6, 70, 14), // "handleOverload"
QT_MOC_LITERAL(7, 85, 17) // "handleMalfunction"

    },
    "ElevatorWidget\0updateDisplay\0\0"
    "handleStateChange\0Elevator::State\0"
    "state\0handleOverload\0handleMalfunction"
};
...
void ElevatorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleStateChange((*reinterpret_cast< Elevator::State(*)>(_a[1]))); break;
        case 2: _t->handleOverload(); break;
        case 3: _t->handleMalfunction(); break;
        default: ;
        }
    }
}
